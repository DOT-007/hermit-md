...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'DOT',
    ...
    BOT_INFO: process.env.BOT_INFO || '(希望@root)[Alosious\]~;$ROZE;917034860457;https://te.legra.ph/file/ae7ca48d04de03e5eec32.jpg',

    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? '(希望@root)[Alosious\]~;$ROZE;917034860457;https://te.legra.ph/file/ae7ca48d04de03e5eec32.jpg' : process.env.AUDIO_DATA,

    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'Hehe' : process.env.STICKER_DATA,
